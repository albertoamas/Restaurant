...
export function Header({ onMenuOpen }: HeaderProps) {
  ...
  return (
    <header
      ...
      style={{
        background: 'oklch(0.12 0.016 40 / 0.92)',
        borderColor: 'oklch(0.26 0.018 40 / 0.80)',
      }}
    >
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={onMenuOpen}
          className="lg:hidden -ml-1 p-1.5 rounded-lg text-gray-400 hover:text-gray-200 hover:bg-white/8 transition-colors"
        ...
        <h2 className="text-[17px] font-bold text-gray-800 font-heading">{title}</h2>
      </div>
      <div className="flex items-center gap-3">
        <ConnectionStatus />
