...
export function CartItem({ item, onIncrement, onDecrement, onRemove }: Props) {
  return (
    <div className="group flex items-center gap-2 py-2.5 border-b border-white/6 last:border-0">
      ...
      <div className="flex items-center gap-1">
        <button
          onClick={onDecrement}
          className="w-8 h-8 flex items-center justify-center rounded-lg border border-white/10 bg-white/5 hover:border-primary-500/40 hover:bg-primary-500/10 text-gray-500 hover:text-primary-400 font-bold text-sm transition-colors"
        >
          −
        </button>
